...
# Model for  class Vendor

class Vendor(models.Model):
    vid = ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefgh12345")

    title = models.CharField(max_length=100, default="Nibbiers")
    image = models.ImageField(upload_to=user_directory_path, default="product.jpg")
    description = models.TextField(null=True, blank=True, default="I am an amazing Vendor")

    address = models.CharField(max_length=100, default="123 Bab ahmer.")
    contact = models.CharField(max_length=100, default="+212614255767")
...
# Model for  class product Review
